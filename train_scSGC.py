...
label_dataset_1 = ['Grace_CITE_CBMC_counts_top2000','Sonya_HumanLiver_counts_top5000']
...
if __name__ == "__main__":
    ...
    datapath = os.path.join('datasets/', args.dataname) 
    embd_file_path = os.path.join('embd/', args.dataname+'.h5')
